...
If you want to use Magento sample data, you need to install them. Sample Data cannnot be removed so proceed only on your
test environment. To install sample data, run the following command :

```bash
bin/magento sampledata:deploy
```

Once it is finished, you will need to run the upgrade command :
